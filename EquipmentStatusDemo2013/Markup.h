...
#define MCD_EOLLEN_EX (sizeof(MCD_EOL_EX)/sizeof(MCD_CHAR)-1) // string length of MCD_EOL
...
public:
	...
	void SetEOL(MCD_STR val) { MCD_EOL = val; }
	void SetEOLLEN(int val) { MCD_EOLLEN = val; }
	void SetBOM(bool val) { m_bBom = val; }
